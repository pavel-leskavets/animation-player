...
class CanvasContainer extends Component {
  ...
  addFrameToContainer = () => {
    ...
    frame.innerHTML = `<div>
            <canvas class='canvas active mini-canvas' id='mini-canvas'></canvas>
  ...
  deleteItem = e => {
    if (e.target.className === "delete-tool-new") {
      ...
      console.log(target.firstChild.firstChild);
    ...
    return (
      <div onClick={this.markActiveFrame}>
        <div className="frame-container" onClick={this.deleteItem}>
          <div className="frame">
            <canvas id="mini-canvas" className="canvas active mini-canvas" />
            <div className="delete-tool">DEL</div>
            <div className="copy-tool">COPY</div>
          </div>

          <div className="create-new-frame" onClick={this.addFrameToContainer}>
            Create New Frame
          </div>
        </div>
      </div>
